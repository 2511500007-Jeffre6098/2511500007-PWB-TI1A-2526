...
<main>
    <section id="home">
        ...
        <p>Where we experimenting with Html5 and style.css.</p>
    </section>
    <section id="about">
        <br><h2><strong>About Us!</strong></h2>
        <p><strong>🆔 NIM:</strong> 2511500007</p>
    <p><strong>👤 Full Name:</strong> Jeffrey Deryata</p>
